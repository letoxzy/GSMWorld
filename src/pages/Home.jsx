...
const FEATURES = [
  { icon: <FiShield />, title: 'Genuine Products', desc: '100% authentic devices' },
    ...
    <div className="home">
      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <p className="hero-desc">
            Premium phones & accessories at Ogbete Main Market, Enugu.
            Best prices, genuine products, expert service.
          </p>
          <div className="hero-btns">
            <Link to="/products" className="btn-primary">Shop Now <FiArrowRight /></Link>
            <a href="https://wa.me/2348064093705" className="btn-outline" target="_blank" rel="noreferrer">
              Chat on WhatsApp
            </a>
          </div>
          <div className="hero-stats">
            <div><strong>500+</strong><span>Products</span></div>
            <div><strong>2000+</strong><span>Customers</span></div>
            <div><strong>5★</strong><span>Rated</span></div>
          </div>
        </div>
        <div className="hero-image">
          <div className="hero-glow" />
          <img src="/hero-phone.png" alt="Featured Phone" onError={e => e.target.style.display = 'none'} />
        </div>
      </section>
      ...
      <section className="section">
        ...
        {loading ? (
          <div className="products-grid">
            {[...Array(4)].map((_, i) => <div className="product-skeleton" key={i} />)}
          </div>
        ) : featured.length > 0 ? (
          <div className="products-grid">
          ...
          <div className="empty-state">
            <p>No products yet. <Link to="/admin/products">Add some products</Link></p>
          </div>
        )}
      </section>
      ...
      <section className="promo-banner">
        <div className="promo-content">
          ...
          <p>Visit us at B139 Railway Line Ogbete Main Market or call <strong>08064093705</strong></p>
          <Link to="/products" className="btn-primary">Browse Deals <FiArrowRight /></Link>
        </div>
      </section>
      ...
      <section className="section">
        ...
        {loading ? (
          ...
          <div className="empty-state"><p>Check back soon for new arrivals!</p></div>
        )}
      </section>
      ...
      <section className="section location-section">
        <h2>Find Us</h2>
        <p className="location-address">📍 B139 Railway Line Ogbete Main Market, Enugu</p>
        ...
        <div className="contact-cta">
          <a href="tel:08064093705" className="btn-primary">📞 Call Us</a>
          <a href="https://wa.me/2348064093705" className="btn-outline" target="_blank" rel="noreferrer">💬 WhatsApp</a>
        </div>
      </section>
    </div>
  )
