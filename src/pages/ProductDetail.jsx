    ...
    <div className="product-detail-page">
      ...
      <div className="product-detail-layout">
        ...
        <div className="product-info">
          ...
          {product.condition && (
            <div
              className={`product-condition ${product.condition.toLowerCase()}`}
            >
              {product.condition === "New" && "✨ Brand New"}
              {product.condition === "Used" && "🔄 Used — Good Condition"}
          ...
          <div className="delivery-info">
            <div className="delivery-item">
              🚚 <span>Delivery available across Enugu</span>
            </div>
            <div className="delivery-item">
        ...
        <div className="tab-content">
          ...
          {activeTab === "reviews" && (
            <div className="reviews-placeholder">
              <p>
                ⭐ {product.reviews || 0} customer reviews. Review system coming
                soon!
              </p>
            </div>
          )}
